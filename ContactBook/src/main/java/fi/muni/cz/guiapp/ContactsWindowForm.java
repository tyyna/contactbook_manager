...
import fi.muni.cz.convertor.Convertor;
import fi.muni.cz.convertor.XSLTProcesor;

/**
 * Main Window Form of GUI, shows all contacts and actions available.
 *
 * @author teena
 */
public class ContactsWindowForm extends javax.swing.JFrame {
    ...
    private class ConvertToXMLWorker extends SwingWorker {
        @Override
        protected Object doInBackground() throws Exception {
            logger.log(Level.INFO, "Converting database to XML.");
        ...
        @Override
        protected void done() {
            logger.log(Level.INFO, "Database succesfully saved to XML.");
        }
    ...
    private class ConvertToHTMLWorker extends SwingWorker {
        ...
        protected Object doInBackground() throws Exception {
            logger.log(Level.INFO, "Converting database to XML.");
            Convertor.convertToXML(manager);
            logger.log(Level.INFO, "Converting database to HTML.");
            XSLTProcesor procesor = new XSLTProcesor();
            procesor.convertToHTML();
            return null;
        }
        
        @Override
        protected void done() {
            logger.log(Level.INFO, "Database succesfully saved to HTML.");
        }
    }
